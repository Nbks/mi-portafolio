export const translations = {
  // Nav
  hero_eyebrow: "Full-stack Developer · Turin, Italy",
  hero_tagline: "Designing high-performance systems across the stack.",
  hero_bio: "Backend-focused Software Engineer specialized in Spring Boot and Angular. I design scalable APIs and fullstack solutions, contribute to architecture decisions, and work across cloud, DevOps, and system infrastructure.",
