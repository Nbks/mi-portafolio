export const translations = {
  // Nav
  hero_eyebrow: "Desarrollador Full-stack · Turin, Italia",
  hero_tagline: "Designing high-performance systems across the stack.",
  hero_bio: "Ingeniero de software centrado en el backend especializado en Spring Boot y Angular. Diseño API escalables y soluciones fullstack, contribuyo a las decisiones de arquitectura y manejo de la nube, DevOps y la infraestructura del sistema.",
  ...
  // Footer
  footer_copyright: "© 2026 Lucas Giavelli",
